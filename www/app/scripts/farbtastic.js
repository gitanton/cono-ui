...
jQuery.farbtastic = function (containerParam, callback) {
    var container = $(containerParam).get(0);
...
jQuery._farbtastic = function (container, callback) {
    ...
    fb.widgetCoords = function (event) {
        ...
        if (typeof event.offsetX !== 'undefined') {
            ...
            var offset = { x: 0, y: 0 };
            while (ew) {
                if (typeof ew.mouseX !== 'undefined') {
                    x = ew.mouseX - offset.x;
                    y = ew.mouseY - offset.y;
                    break;
                }
                offset.x += ew.offsetLeft;
                offset.y += ew.offsetTop;
                ew = ew.offsetParent;
            }
